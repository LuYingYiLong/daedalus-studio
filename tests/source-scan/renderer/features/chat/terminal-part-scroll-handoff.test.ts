...
const terminalPartSource: string = fs.readFileSync(path.join(root, "src/renderer/src/widgets/conversation/TerminalPart.tsx"), "utf8");
const messageListSource: string = fs.readFileSync(path.join(root, "src/renderer/src/widgets/conversation/MessageList.tsx"), "utf8");

import type { PlanApprovalState, PlanClarificationState, PlanRecommendedReply, SessionMetadata, WorkbenchSnapshot } from "@/platform/rpc/types";
import type { PlanResult } from "@/platform/rpc/plan-api";

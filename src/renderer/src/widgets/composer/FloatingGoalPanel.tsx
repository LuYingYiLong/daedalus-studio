...
import { applyGoalRollback, cancelGoal, extendGoalBudget, getCurrentGoal, previewGoalRollback, resumeGoal } from "@/platform/rpc/goal-api";
import type { AgentGoalState, WorkflowTodoSnapshot, WorkflowTodoStep } from "@/platform/rpc/types";
import {

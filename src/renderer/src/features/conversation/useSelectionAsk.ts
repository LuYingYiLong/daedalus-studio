import type { MessageTextAnchor, SelectionAskMessage, SelectionAskThread, SelectionAskThreadPage } from "@/platform/rpc/types";
import { cancelSelectionAskResponse, createSelectionAskThread, deleteAllSelectionAskThreads, deleteSelectionAskThread, getSelectionAskThread, listSelectionAskThreads, sendSelectionAskMessage } from "@/platform/rpc/session-api";
...
import { getMessageAnchorKey } from "@/domain/conversation/message-text-anchor";

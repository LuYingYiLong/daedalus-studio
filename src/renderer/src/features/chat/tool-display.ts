...
const TOOL_DISPLAY_TEMPLATES: Record<string, ToolDisplayTemplate> = {
	...
	mcp_godot_get_runtime_status: { label: "Check Godot runtime", iconName: "status_success" },
	...
	mcp_godot_lsp_get_status: { label: "Check language server", iconName: "status_success" },
	...
	mcp_godot_dap_get_status: { label: "Check debugger status", iconName: "status_success" },

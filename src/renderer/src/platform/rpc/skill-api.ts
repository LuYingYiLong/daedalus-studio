...
export async function setSkillEnabled(
	...
	return client.request<SkillListResult>("skill.set_enabled", {
		ref,
		enabled,
		...target,
	});
...
export async function fetchSkillContent(
	ref: string,
	target: SkillTarget = {},
): Promise<{ ref: string; content: string }> {
	const client = await createBackendClient();

	return client.request<{ ref: string; content: string }>("skill.get", {
		ref,
		...target,
	});
}
...
export async function updateSkillContent(
	...
	return client.request<SkillListResult>("skill.update", {
		ref,
		content,
		...target,
	});
